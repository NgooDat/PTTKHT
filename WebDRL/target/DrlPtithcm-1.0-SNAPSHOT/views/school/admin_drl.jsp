                        ...
                        <ul class="account_list">
                            <li class="account_item account_item_undeline">
                                <a class="login_form_line" style="margin-top: 8px;">Tài khoản: <span
                                        class="account_name">Quản lý học viện</span></a>
                            </li>
                            ...
                            <form class="form-table" action="">
                                <div class="main-table-title-wrap">
                                    ...
                                    <div class="main-table-button"> <!--Thêm xóa sửa balabala-->
                                        <select id="mySelect" autofocus>
                                            ...
                                            <a class="option-link" href="#">Chọn khoa</a>
                                            </option>
                                            <option value="#">
                                            <a class="option-link" href="#">An toàn thông tin</a>
                                            </option>

                                        </select>
                                        <select id="mySelect" autofocus>
                                            <option value="#" selected>
                                            <a class="option-link" href="#">Chọn lớp</a>
                                            </option>
                                            <option value="#">
                                            <a class="option-link" href="#">D21CQAT01-N</a>
                                            </option>

                                        </select>
                                        <select id="mySelect" autofocus>
                                            <option value="#" selected>
                                            <a class="option-link" href="#">Chọn học kỳ</a>
                                            </option>
                                            <option value="#">
                                            <a class="option-link" href="#">I 2024-2025</a>
                                            </option>
                                ...
                                <ul class="main-table">
                                    ...
                                    <div class="table-content-wrap">
                                        <li id="original-div9" class="main-table-item">
                                            <ul class="table-header-list">
                                                ...
                                                <li class="table-header-item table-item-content width_2">
                                                    <span class="button none-button width_2 width_text">N21DCAT006</span>
                                                </li>
                                                <li class="table-header-item table-item-content width_3 padding-title">
                                                    <span class="button none-button width_3 width_text">Ngô Ngọc Minh
                                                        Châu</span>
                                                </li>
                                                <li class="table-header-item table-item-content width_4">
                                                    <span class="button none-button width_4 width_text">92</span>
                                                </li>
                                                <li class="table-header-item table-item-content width_5">
                                                    <span class="button none-button width_5 width_text">90</span>
                                                </li>
                                                <li class="table-header-item table-item-content width_6">
                                                    <span class="button none-button width_5 width_text">99</span>
                                                </li>
