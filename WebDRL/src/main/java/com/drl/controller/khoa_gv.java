...
@WebServlet(name = "khoa-gv", urlPatterns = {"/khoa-gv"})
public class khoa_gv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        dispatcher = request.getRequestDispatcher("views/khoa/updategv.jsp");
        dispatcher.forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("khoa-gv?id=" + request.getParameter("idaccount"));
