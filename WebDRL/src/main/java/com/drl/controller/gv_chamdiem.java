...
@WebServlet(name = "gv_chamdiem", urlPatterns = {"/gv-chamdiem"})
public class gv_chamdiem extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            public void run() {
                ...
                if (request.getParameter("iddsave") != null) {
                    for (int i = 0; i < dsDRL.size(); i++) {
                        ...
                        new DRL_dao().updateStatus(4, id, hkk.getId());
        ...
        dispatcher = request.getRequestDispatcher("views/gv/gv_chamdiem.jsp");
        dispatcher.forward(request, response);
    }
                    ...
                    if (dsDRL.get(0).getStatus() == 5) {
                        ...
                        if (request.getParameter("iddsave") != null) {
                            for (int i = 0; i < dsDRL.size(); i++) {
                                ...
                                k.setDiemSV(diem);
                                k.setStatus(3);
                                new DRL_dao().updateDiemCV(k.getId(), diem);
                                new DRL_dao().updateStatus(4, k.getSinhVienID(), hkk.getId());
