                    ...
                    Future<Void> future2 = (Future<Void>) ThreadPool.executorService.submit(() -> {
                        ...
                        if (request.getParameter("gv-name") != null) {
                            ...
                            try {
                                ...
                                Logger.getLogger(khoa_sinhvien.class.getName()).log(Level.SEVERE, null, ex);
                            }
...
//                        }
                        ...
                        request.setAttribute("lopSelectList", lop);
                        dsSV = new Sinh_Vien_dao().getSV_by_KhoaID((String) session.getAttribute("username"));
...
//                        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(khoa_sinhvien.class
