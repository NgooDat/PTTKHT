...
@WebServlet(name = "khoa-sv", urlPatterns = {"/khoa-sv"})
public class khoa_sv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("id")==null){
            response.sendRedirect("khoa-home");
            return;
        }
        ...
        dispatcher = request.getRequestDispatcher("views/khoa/updatesv.jsp");
        dispatcher.forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("khoa-sv?id=" + request.getParameter("idaccount"));
