            ...
            switch (username) {
                ...
                default:
                    ...
                    Future<Void> future = ThreadPool.executorService.submit(() -> {
                        ...
                        dsGV = new Giang_Vien_dao().getGiangVien_by_KhoaID((String)session.getAttribute("username"));
                        return null;
                    });
                     {
                        try {
                            ...
                            Logger.getLogger(khoa_giangvien.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
