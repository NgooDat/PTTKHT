...
@WebServlet(urlPatterns = {"/khoa_drl"})
public class khoa_drl extends HttpServlet {
                ...
                default:
                    ...
                    Future<Void> future = ThreadPool.executorService.submit(() -> {
                        ...
                        if (request.getParameter("idhuy") != null) {
                            new DRL_dao().updateScoresToZero(request.getParameter("idduyet"), Integer.parseInt(request.getParameter("hk")));
                        ...
                        int hkxet = xet.getId();
                        Thong_Bao tb = new Thong_Bao_dao().getThongBaoByHK_NKID(hkxet);
...
//              
//                        }
                        dsLop = (ArrayList<Lop>) new Lop_dao().getLop_by_KhoaID((String) session.getAttribute("username"));
                        request.setAttribute("lopSelectList", dsLop);
                        drlList = (ArrayList<DRL>) new DRL_dao().getAllDRLWithTotal_Khoa(hkxet, (String) session.getAttribute("username"));
                        //lọc theo lớp
                    ...
                    RequestDispatcher dispatcher = request.getRequestDispatcher("views/khoa/khoa_drl.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(khoa_drl.class
