            ...
            <div class="container container_body">
                ...
                <div class="login_form_menu">
                    ...
                    <div class="login_form menu">
                        ...
                        <ul class="menu_list">
                            <li class="menu_item">
                                <a href="gv-tkb" class="login_form_line menu-item-link" data-target="table_home">
                            ...
                            <li class="menu_item">
                                <a href="gv-home?id=<%=session.getAttribute("username")%>" class="login_form_line menu-item-link" data-target="table_home">
                                    <svg class="icon_item" fill="none" viewBox="0 0 24 24">
                                    <path d="m8.91003 19.9201 6.51997-6.52c.77-.77.77-2.03 0-2.8l-6.51997-6.52002"
                                          stroke="#292d32" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-miterlimit="10" stroke-width="1.5" />
                            ...
                            <li class="menu_item">
                                ...
                                <a href="gv-lop?id=<%=session.getAttribute("username")%>" class="login_form_line menu-item-link" data-target="table_class">
                                    <svg class="icon_item" fill="none" viewBox="0 0 24 24">
                                    <path d="m8.91003 19.9201 6.51997-6.52c.77-.77.77-2.03 0-2.8l-6.51997-6.52002"
                                          stroke="#292d32" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-miterlimit="10" stroke-width="1.5" />
