...
<%@page import="com.drl.daos.HK_NK_dao"%>
                        ...
                        <div class="main-table-wrap">
                            <form class="form-table" action="">
                                <div class="main-table-title-wrap">
                                    <h1 class="main-table-title">Kết quả điểm rèn luyện các kỳ của bạn
                                                    ...
                                                    if (drlList != null && !drlList.isEmpty()) {
                                                        ...
                                                        for (Object o : drlList) {
                                                            if (o instanceof DRL) {
                                                                ...
                                                                HK_NK hkk = new HK_NK_dao().getHK_NK_by_ID(drl.getHkNkID());
                                                                htmlOutput.append("<li class=\"table-header-item table-item-content width_7\">");

// Thêm thông tin học kỳ và niên khóa vào chuỗi HTML
                                                                htmlOutput.append(hkk.getHocKy()).append(" ").append(hkk.getNienKhoa());
