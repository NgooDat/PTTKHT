            ...
            <div class="container container_body">
                ...
                <div class="login_form_menu">
                    ...
                    <div class="login_form menu">
                        ...
                        <ul class="menu_list">
                            <li class="menu_item">
                                <a href="sv-tkb" class="login_form_line menu-item-link" data-target="table_home">
                            ...
                            <li class="menu_item">
                                <a href="sv-home?id=<%=session.getAttribute("username")%>" class="login_form_line menu-item-link" data-target="table_home">
                                    <svg class="icon_item" fill="none" viewBox="0 0 24 24">
                                    <path d="m8.91003 19.9201 6.51997-6.52c.77-.77.77-2.03 0-2.8l-6.51997-6.52002"
                                          stroke="#292d32" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-miterlimit="10" stroke-width="1.5" />
                            ...
                            <li class="menu_item">
                                <a href="sv-drl?id=<%=session.getAttribute("username")%>" class="login_form_line menu-item-link" data-target="table_khoa">
                                    <svg class="icon_item" fill="none" viewBox="0 0 24 24">
                                    <path d="m8.91003 19.9201 6.51997-6.52c.77-.77.77-2.03 0-2.8l-6.51997-6.52002"
                                          stroke="#292d32" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-miterlimit="10" stroke-width="1.5" />
                            ...
                            <li class="menu_item">
                                <a href="sv-check?id=<%=session.getAttribute("username")%>" class="login_form_line menu-item-link" data-target="table_tkb">
                                    <svg class="icon_item" fill="none" viewBox="0 0 24 24">
                                    <path d="m8.91003 19.9201 6.51997-6.52c.77-.77.77-2.03 0-2.8l-6.51997-6.52002"
                                          stroke="#292d32" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-miterlimit="10" stroke-width="1.5" />
                                ...
                                <div class="main-top-left">
                                    <div class="main-table-wrap table_khoahoc">
                                        <div class=" hkti">
                                            ...
                                            <div class="sewrap">
                                                <select disabled style ="color: black; text-align: center; font-size: 16px" class="sel">
                                                    <%
                                                        try {
                                                    ...
                                                    %>
                                                    <option ><%= t.getHocKy()%> <%= t.getNienKhoa()%></option>
                                                    <%
                                                                }
                                                            }
                                                        } catch (Exception e) {
                                    ...
                                    <div class="main-table-wrap ">
                                        <form id="updateForm" action="school_tkb" method="post" >
                                            <div class="main-table-title-wrap">
                                                <h1 class="main-table-title">Thời gian chấm điểm rèn luyện
                                            ...
                                            <div class="time-wrap">
                                                <div class="time-items">
                                                    ...
                                                    <input disabled style ="color: black; text-align: center; font-size: 16px" value="<%= ngayBD%>" name="date1" id="startDate" class="input-item" type="date">
                                                </div>
                                                <div class="time-items">
                                                    <label class="label-iteam">Hạn nộp của sinh viên:</label>
                                                    <input disabled style ="color: black; text-align: center; font-size: 16px" value="<%= ngayKT_SV%>" name="date2" id="studentDeadline" class="input-item" type="date">
                                                </div>
                                                <div class="time-items">
                                                    <label class="label-iteam">Hạn nộp của ban cán sự: </label>
                                                    <input disabled style ="color: black; text-align: center; font-size: 16px" value="<%= ngayKT_CS%>" name="date3" id="classRepDeadline" class="input-item" type="date">
                                                </div>
                                                <div class="time-items">
                                                    <label class="label-iteam">Hạn nộp của cố vấn học tập:</label>
                                                    <input disabled style ="color: black; text-align: center; font-size: 16px" value="<%= ngayKT_CV%>" name="date4" id="advisorDeadline" class="input-item" type="date">
                                                </div>
                                                <div class="time-items">
                                                    <label class="label-iteam">Hạn nộp của khoa:</label>
                                                    <input disabled style ="color: black; text-align: center; font-size: 16px" value="<%= ngayKT_Khoa%>" name="date5" id="departmentDeadline" class="input-item" type="date">
                                                </div>
                                            </div>
