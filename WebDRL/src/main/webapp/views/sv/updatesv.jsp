                    ...
                    <div class="main_content_home table_class_home table_tkb">
                        ...
                        <div class="tkb">
                            <div class="main-top-right table_tb">
                                <form action="sv-home" method="post">
                                    <div class="main-table-wrap ">
                                        <div class="main-table-title-wrap">
                                            <h1 class="main-table-title">Thông tin cá nhân

                                            </h1>
                                            <button onclick="confirmLink(event, 'Xác nhận lưu?')" class="button width button-add login_form_button">
                                        ...
                                        <%
                                            Sinh_Vien sv = (Sinh_Vien) request.getAttribute("sv");
                                        %>
                                        ...
                                        <div class="time-wrap wrappp">
                                            <div class="time-items item">
                                                ...
                                                <input style="background: #eee" name="idaccount" class="input-item item" readonly type="text" value="<%=sv.getId()%>">
                                            </div>
                                            <div class="time-items item">
                                                <div class="labellabel">
                                                    <label class="label-iteam label2">Lớp: </label>
                                                </div>
                                                <%
                                                    Lop kh = new Lop_dao().getLop_by_ID(sv.getLopID());
                                                %>
                                            ...
                                            <div class="time-items item">
                                                ...
                                                <input name="hoTen" accept-charset="UTF-8" class="input-item item" type="text" placeholder="Họ và tên" value="<%=sv.getHoTen()%>">
                                            </div>
                                            <div class="time-items item">
                                                <div class="labellabel">
                                            ...
                                            <div class="time-items item">
                                                <div class="labellabel">
                                                    <%
                                                        ...
                                                        String ngayBD = sv.getNgaySinh() != null ? dateFormat.format(sv.getNgaySinh()) : "";
                                                    %>
                                            ...
                                            <div class="time-items item">
                                                ...
                                                <%
                                                    Tai_Khoan tk = new Tai_Khoan_dao().getTaiKhoan_by_email(sv.getId());
                                                %>
                                            ...
                                            <div class="time-items item mail">
                                                ...
                                                <input style="background: #eee" class="input-item" type="text" readonly value="<%=sv.getEmail()%>">
                                            </div>
                                            <div class="time-items item2">
                                                <label class="label-iteam item2">Địa chỉ:</label>
                                                <input name="add" class="input-item"  accept-charset="UTF-8" type="text" value="<%=sv.getDiaChi()%>">
                                            </div>
                                            <div class="time-items item2 last">
                                                <label class="label-iteam item2">Quê quán:</label>
                                                <input name="add2" class="input-item" type="text" accept-charset="UTF-8" value="<%=sv.getQueQuan()%>">
                                            </div>
                                        </div>
