                        ...
                        <div class="main-table-wrap">
                            ...
                            <div class="main-table-title-wrap">
                                ...
                                <div class="main-table-button"> <!--Thêm xóa sửa balabala-->
                                    ...
                                    <select id="khoaSelect" onchange="if (this.value) {
                                        ...
                                        <option value="school_giangvien?khoaId=allKhoa" <%= selected%>>Tất cả</option>
                                        <%
                                        ...
                                        %>
                                        <option value="school_giangvien?khoaId=<%=khoa.getId()%>" <%= selected%>><%=khoa.getTen()%></option>
                                        <%
                                                }
                                            }
                                        %>
                            ...
                            <ul class="main-table">
                                ...
                                <li id="original-div6" class="main-table-item">
                                    ...
                                    %>
                                    <form action="school_giangvien" method="get">
                                        <ul id ="wrap<%=i%>" class="table-header-list">
                                            ...
                                            <li class="table-header-item table-item-content width_5" style="justify-content: center">
                                                ...
                                                <a  style="<%=status%>; border-radius: 50%" href="school_giangvien?wrap=wrap<%=i%>&lock=<%=gv.getId()%>&opt=<%=selectedKhoaId%>" 
                                            ...
                                            <li class="table-header-item table-item-content width_6">
                                                ...
                                                <a href="updategv?id=<%=gv.getId()%>" style="margin: 0px 4px; background: #dd5600" class="button button-edit special" 
                                                        >
                                                    <svg class="edit_icon" viewBox="0 0 24 24">
                                                ...
                                                <a href="school_giangvien?wrap=wrap<%=i%>&del=<%=gv.getId()%>&opt=<%=selectedKhoaId%>" 
                                        ...
                                        %>
                                    <form id ="wrap<%=i%>"  action="school_giangvien" method="get" onsubmit="return validateForm()">
