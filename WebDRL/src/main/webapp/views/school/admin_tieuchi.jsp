                    ...
                    <div class="main_content_home table_class_home table_tieuchi">
                        ...
                        <div class="main-table-wrap">
                            ...
                            <div class="main-table-title-wrap">
                                <h1 class="main-table-title">Bảng các tiêu chí đánh giá

                                </h1>
                                <div class="main-table-button"> <!--Thêm xóa sửa balabala-->
                                    <a href="school_tieuchi?iddel=add-tieu-chi" onclick="confirmLink(event)" class="button button-add">
                            ...
                            <ul class="main-table">
                                ...
                                <li id="original-div7" class="main-table-item">
                                    <%
                                        int i = 1;
                                        Object obj = request.getAttribute("tieuChi");
                                        if (obj instanceof ArrayList<?>) {
                                            ArrayList<?> tieuchi = (ArrayList<?>) obj;

                                            if (tieuchi != null && !tieuchi.isEmpty()) {
                                                for (Object o : tieuchi) {
                                                    if (o instanceof Tieu_Chi) {
                                                        Tieu_Chi tc = (Tieu_Chi) o;

                                    %>
                                    <form action="school_tieuchi">
                                        <ul class="table-header-list">
                                            <input name="iddadd" value="<%=tc.getId()%>" type="hidden">
                                            ...
                                            <li class="table-header-item table-item-content width_2 padding-title">
                                                <input name ="noidung"  class="button none-button width_2 width_text" value="<%=tc.getNoiDung()%>">
                                            </li>
                                            <li class="table-header-item table-item-content width_3">
                                                <input name ="diem"  class="button none-button width_3 width_text" value="<%=tc.getTongDiem()%>">
                                            ...
                                            <li class="table-header-item table-item-content width_4">
                                                ...
                                                <a href="school_tieuchi?iddel=<%= tc.getId()%>" onclick="confirmLink(event, 'Xác nhận xóa?')" class="button button-delete">
