                        ...
                        <div class="main-table-wrap">
                            ...
                            <div class="main-table-title-wrap">
                                ...
                                <div class="main-table-button"> <!--Thêm xóa sửa balabala-->
                                    ...
                                    <select id="khoaSelect" onchange="if (this.value) {
                                        ...
                                        %>
                                        <option value="school_sinhvien?khoaId=<%=khoa.getId()%>" <%= selected%>><%=khoa.getTen()%></option>
                                        <%
                                                }
                                            }
                                        %>
                                    ...
                                    <select id="khoaSelect" onchange="if (this.value) {
                                        ...
                                        %>
                                        <option value="school_sinhvien?khoaId=<%=selectedKhoaId%>&lopId=<%=lop.getId()%>" <%= selected%>><%=lop.getTen()%></option>
                                        <%
                                                }
                                            }
                                        %>
                            ...
                            <ul class="main-table">
                                ...
                                <li id="original-div8" class="main-table-item">
                                                ...
                                                for (Object o : svList) {
                                                    if (o instanceof Sinh_Vien) {
                                                        ...
                                                        htmlOutput.append("<li class=\"table-header-item table-item-content width_5\" style=\"justify-content: center\">")
                                                                .append("<a style=\"").append(status).append("; border-radius: 50%\" href=\"school_sinhvien")
                                                                ...
                                                                .append("<a href=\"updatesv?id=").append(sv.getId()).append("\" style=\"margin: 0px 4px; background: #dd5600\" class=\"button button-edit special\">")
                                                                ...
                                                                .append("<a href=\"school_sinhvien?wrap=wrap").append(i-1)
                                    ...
                                    <form id="open" style="display:none" action="school_sinhvien" method="get" onsubmit="return validateForm()">
                                        <ul  id ="wrap<%=i%>" class="table-header-list">
                                            ...
                                            <li class="table-header-item table-item-content width_7">
                                                ...
                                                <a href="school_sinhvien?wrap=wrap<%=i%>" 
