                                ...
                                <div class="main-table-title-wrap">
                                    ...
                                    <div class="main-table-button"> <!--Thêm xóa sửa balabala-->
                                        ...
                                        <select id="khoaSelect" onchange="if (this.value) {
                                            ...
                                            %>
                                            <option value="school_drl?khoaId=<%=khoa.getId()%>" <%= selected%>><%=khoa.getTen()%></option>
                                            <%
                                                    }
                                                }
                                            %>
                                        ...
                                        <select id="khoaSelect" onchange="if (this.value) {
                                            ...
                                            %>
                                            <option value="school_drl?khoaId=<%=selectedKhoaId%>&lopId=<%=lop.getId()%>" <%= selected%>><%=lop.getTen()%></option>
                                            <%
                                                    }
                                                }
                                            %>
                                                    ...
                                                    if (drlList != null && !drlList.isEmpty()) {
                                                        ...
                                                        for (Object o : drlList) {
                                                            if (o instanceof DRL) {
                                                                ...
                                                                if (status != 5) {
                                                                    htmlOutput.append("<a href=\"school_drl?idduyet=")
                                                                            ...
                                                                            .append("&wrapId=wrap")
                                                                            .append(i)
                                                                            .append("\" class=\"button button-edit\" ")
                                                                            .append("onclick=\"confirmLink(event, 'Bạn có chắc chắn muốn duyệt không?')\">Duyệt</a>");

                                                                    htmlOutput.append("<a href=\"school_drl?idhuy=")
                                                                            .append(drl.getSinhVienID())
                                                                            .append("&hk=")
                                                                            .append(drl.getHkNkID())
                                                                            .append("&khoaId=")
                                                                            ...
                                                                            .append("&wrapId=wrap")
                                                                            .append(i)
                                                                            .append("\" class=\"button button-delete\" ")
                                                                            .append("onclick=\"confirmLink(event, 'Bạn có chắc chắn muốn hủy bỏ không?')\">Hủy bỏ</a>");
