                        ...
                        <div class="main-table-wrap">
                            <div class="main-table-title-wrap">
                                ...
                                <div style="display:flex" class="main-table-button"> <!--Thêm xóa sửa balabala-->
                                    <div style="transform: translateY(-2px)" class="select-title"><span> </span></div>
                            ...
                            <ul class="main-table">
                                ...
                                <li id="original-div5" class="main-table-item">
                                    ...
                                    <%
                                        String selectedKhoaId ="", selected="";
                                        int i = 1;
                                    ...
                                    %>
                                    <form action="khoa_lop" method="get">
                                        <ul id ="wrap<%=i%>" class="table-header-list">
                                            ...
                                            <li class="table-header-item table-item-content width_6">
                                                ...
                                                <a href="khoa_lop?wrap=wrap<%=i%>&del=<%=lop.getId()%>" onclick="confirmLink(event, 'Xác nhận xóa?')" class="button button-delete">
                                    ...
                                    %>
                                    <form  action="khoa_lop" method="get"  onsubmit="return validateForm()">
                                        <ul id="open" style="display:none" class="table-header-list">
                                            ...
                                            <li class="table-header-item table-item-content width_6">
                                                ...
                                                <a href="khoa_lop" onclick="confirmLink(event, 'Xác nhận thoát?')" class="button button-delete">
