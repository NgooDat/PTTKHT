...
<html class="no-js" lang="vi">
    ...
    <body
                                ...
                                <div class="main-table-title-wrap">
                                    ...
                                    <div class="main-table-button"> <!--Thêm xóa sửa balabala-->
                                        ...
                                        <select style="display:none" disabled id="khoaSelect" onchange="if (this.value) {
                                            ...
                                            %>
                                            <option value="khoa_drl?khoaId=<%=khoa.getId()%>" <%= selected%>><%=khoa.getTen()%></option>
                                            <%
                                                    }
                                                }
                                            %>
                                        ...
                                        <select id="khoaSelect" onchange="if (this.value) {
                                            ...
                                            %>
                                            <option value="khoa_drl?khoaId=<%=selectedKhoaId%>&lopId=<%=lop.getId()%>" <%= selected%>><%=lop.getTen()%></option>
                                            <%
                                                    }
                                                }
                                            %>
                                                    ...
                                                    if (drlList != null && !drlList.isEmpty()) {
                                                        ...
                                                        for (Object o : drlList) {
                                                            if (o instanceof DRL) {
                                                                ...
                                                                if (status != 5) {
                                                                    htmlOutput.append("<a onclick=\"return kiemTraThoiGian()\" href=\"khoa_drl?idduyet=")
                                                                            .append(drl.getSinhVienID())
                                                                            .append("&hk=")
                                                                            .append(drl.getHkNkID())
                                                                            .append("&khoaId=")
                                                                            .append(selectedKhoaId)
                                                                            .append("&lopId=")
                                                                            .append(selectedLopId)
                                                                            .append("&wrapId=wrap")
                                                                            .append(i)
                                                                            .append("\" class=\"button button-edit\">Duyệt</a>");

                                                                    htmlOutput.append("<a onclick=\"return kiemTraThoiGian()\" href=\"khoa_drl?idhuy=")
                                                                            .append(drl.getSinhVienID())
                                                                            .append("&hk=")
                                                                            .append(drl.getHkNkID())
                                                                            .append("&khoaId=")
                                                                            ...
                                                                            .append("&wrapId=wrap")
                                                                            .append(i)
                                                                            .append("\" class=\"button button-delete\">Hủy bỏ</a>");

                                                                } else {
                                                                    htmlOutput.append("<a class=\"button button-edit\">Đã duyệt</a>");
                                                                }
        ...
        <%                                                    
            ...
            java.util.Date ngayBD = tb.getNgayKT_CV();
            java.util.Date ngayKT_SV = tb.getNgayKT_Khoa();
