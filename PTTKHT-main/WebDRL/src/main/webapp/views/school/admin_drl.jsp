                                        ...
                                        <div id="original-div9" class="main-table-item">
                                            <%
                                                ...
                                                if (obj instanceof ArrayList<?>) {
                                                    ArrayList<?> drlList = (ArrayList<?>) obj;
                                            ...
                                            <ul class="table-header-list">
                                                ...
                                                <li class="table-header-item table-item-content width_2">
                                                    <span class="button none-button width_2 width_text"><%= drl.getSinhVienID() %></span>
                                                </li>
                                                <li class="table-header-item table-item-content width_3 padding-title">
                                                    <%
                                                        Sinh_Vien sv = Sinh_Vien_dao.getSV_by_id(drl.getSinhVienID());
                                                        String name = sv.getHoTen();
                                                    %>
                                                    <span class="button none-button width_3 width_text"><%= name %>
                                                        </span>
                                                </li>
                                                <li class="table-header-item table-item-content width_4">
                                                    <span class="button none-button width_4 width_text"><%= drl.getDiemSV() %></span>
                                                </li>
                                                <li class="table-header-item table-item-content width_5">
                                                    <span class="button none-button width_5 width_text"><%= drl.getDiemCS() %></span>
                                                </li>
                                                <li class="table-header-item table-item-content width_6">
                                                    <span class="button none-button width_5 width_text"><%= drl.getDiemCV() %></span>
                                                </li>
